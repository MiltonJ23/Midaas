  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#5E0E08] via-[#7A1A12] to-[#5E0E08] p-[2px]">
      <div className="relative bg-white rounded-2xl p-6">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#F6C305]/5 to-transparent rounded-full -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-[#F6C305]/5 to-transparent rounded-full translate-y-1/2 -translate-x-1/2" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
          {/* Icon */}
          <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-[#F6C305] to-[#E0B004] flex items-center justify-center shadow-lg">
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-6 pt-6 border-t border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[#F6C305]/10 flex items-center justify-center flex-shrink-0">
              <Briefcase className="w-4 h-4 text-[#F6C305]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[#F6C305]/10 flex items-center justify-center flex-shrink-0">
              <Sparkles className="w-4 h-4 text-[#F6C305]" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900">
                Simple & Sécurisé
