  ...
  const renderFileUploadArea = (
    ...
    return (
      <div className="space-y-3">
        ...
        {/* Add button */}
        <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-slate-200 rounded-lg cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-colors">
          <Upload className="w-4 h-4 text-slate-400" />
          <span className="text-sm text-slate-500">Add files</span>
          <input
            ref={(el) => {
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-xs text-slate-400 hover:text-primary border border-dashed border-gray-300 hover:border-primary px-2.5 py-1 rounded-full transition-colors"
