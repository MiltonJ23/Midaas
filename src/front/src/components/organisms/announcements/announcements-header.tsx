      ...
      <div className="flex items-center gap-3">
        ...
        {announcementCount !== undefined && (
          <span className="px-3 py-1 bg-gray-100 text-gray-700 text-sm font-medium rounded-full">
            {announcementCount} annonce{announcementCount !== 1 ? "s" : ""}
          </span>
        )}
      </div>
      {onAddAnnouncement && (
        <button
          ...
          className="px-6 py-3 bg-[#F6C305] text-white text-sm font-medium rounded-lg hover:bg-[#4a0f0a] transition-colors flex items-center gap-2"
        >
          <svg
            width="16"
            height="16"
