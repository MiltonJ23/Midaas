              ...
              <div>
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00de00] focus:border-transparent bg-white appearance-none cursor-pointer"
                      style={{
