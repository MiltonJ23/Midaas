                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F6C305] focus:border-transparent"
                      disabled={loading}
                    />
                  )}
                />
              ...
              <div>
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F6C305] focus:border-transparent bg-white appearance-none cursor-pointer"
                      style={{
