      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {onAddService && (
          <button
            ...
            className="px-4 py-2 bg-[#F6C305] text-white text-xs font-medium rounded-lg hover:bg-[#4a0f0a] transition-colors uppercase"
          >
            Ajouter un service
          </button>
        )}
      ...
      <div className="space-y-4">
        {services.length === 0 ? (
          ...
          services.map((service) => (
            <div
              key={service.id}
              className="border border-gray-200 rounded-lg p-4 hover:border-[#F6C305] transition-colors"
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  ...
                  <p className="text-[#F6C305] font-MontserratBold text-base">
                    {service.price}
                  </p>
                </div>
